...
@include('crud::fields.inc.wrapper_start')
    ...
    {{-- PREVIEW --}}
    @if (isset($field['preview']) && isset($field['value']) && $field['preview'] == true )
      <div class="text-center">
        <label for="custom-preview-img"> Old image: </label>
        <img id="custom-preview-img" src="/storage/{{$field['value']}}" class="img-thumbnail m-1" alt="thumbnail image" height="400" width="400">
      </div>
    @endif
